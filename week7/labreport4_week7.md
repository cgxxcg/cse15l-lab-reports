...
I typed: i#<spacebar/>incrementation in the second loop changed from index1 to index2<esc>:wq! <br>
By typing "i", I entered insert mode so I could type my commit message. Then I typed my commit message and by pressing <esc> key, I exit the insert mode coming back to standard mode. Then I typed ":wq!". This saves my change in the file and exits vim. 
